...
NODE_MODIFIER_POOL: dict[Stat, NodeModifierDef] = {
    ...
    Stat.CRIT_DMG_INC:                 NodeModifierDef(Stat.CRIT_DMG_INC,                 0.05, 0.10, 0.15, "%"),
    Stat.ATTACK_CRIT_DMG_INC:          NodeModifierDef(Stat.ATTACK_CRIT_DMG_INC,          0.05, 0.10, 0.15, "%"),
    Stat.SPELL_CRIT_DMG_INC:           NodeModifierDef(Stat.SPELL_CRIT_DMG_INC,           0.05, 0.10, 0.15, "%"),
    Stat.MINION_CRIT_DMG_INC:          NodeModifierDef(Stat.MINION_CRIT_DMG_INC,          0.05, 0.10, 0.15, "%"),
    Stat.PHYSICAL_CRIT_DMG_INC:        NodeModifierDef(Stat.PHYSICAL_CRIT_DMG_INC,        0.05, 0.10, 0.15, "%"),
    Stat.LIGHTNING_CRIT_DMG_INC:       NodeModifierDef(Stat.LIGHTNING_CRIT_DMG_INC,       0.05, 0.10, 0.15, "%"),
    Stat.COLD_CRIT_DMG_INC:            NodeModifierDef(Stat.COLD_CRIT_DMG_INC,            0.05, 0.10, 0.15, "%"),
    Stat.FIRE_CRIT_DMG_INC:            NodeModifierDef(Stat.FIRE_CRIT_DMG_INC,            0.05, 0.10, 0.15, "%"),
    Stat.EROSION_CRIT_DMG_INC:         NodeModifierDef(Stat.EROSION_CRIT_DMG_INC,         0.05, 0.10, 0.15, "%"),
